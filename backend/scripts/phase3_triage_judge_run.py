"""Phase 3 Triage 2차 시도 — 완성된 실제 대화에 _check_1e(대화 품질) 판정."""
import asyncio
import json
import sys
...
STATE_FILES = {
    "심한 피부 가려움 (강아지)": "/tmp/phase3/case1_skin.json",
    "다음다뇨 (고양이)": "/tmp/phase3/case2_pud.json",
}

OUT_PATH = Path("/app/ai/agents/eval_cases/triage_judge_calibration.json")
